       ...
       <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12">
             <div class="s-heading-section">
                <h2><a href="{{asset('javascript:;')}}">Hotel Listing Grid View</a></h2>
                <ul>
                   <li><a href="{{asset('index-01.html')}}">Home</a></li>
                   <li><a href="{{asset('javascript:;')}}"><i class="fas fa-chevron-right"></i></a></li>
                   <li><a href="{{asset('javascript:;')}}">Categories View</a></li>
                </ul>
             </div>
          </div>
       </div>
           ...
           <div class="row">
              <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                 ...
                 <div class="find-us-wrapper">
                    <h4><a href="{{asset('javascript:;')}}">find Us</a></h4>
                    <ul>
                       <li>
                       ...
                       <li class="t-center">
                                <button class="section3_btn  fw-bold w-100  btn22" type="button">search</button>
                       </li>
                    </ul>
                 </div>
                 <!-- find us section over -->
                 <div class="top-deals-wrapper">
                    <h4><a href="{{asset('javascript:;')}}">top deals</a></h4>
                    <ul>
                       <li>
                 ...
                 <div class="rating-wrapper">
                    <h4><a href="{{asset('javascript:;')}}">Star Rating</a></h4>
                    <ul>
                       <li class="p-rel">
                          <input type="checkbox" class="checkbox" >
                 ...
                 <div class="r-type-wrapper">
                    <h4><a href="{{asset('javascript:;')}}">Rooms Types</a></h4>
                    <ul>
                       <li>
                          <input type="checkbox" class="checkbox" >
                          <label >Duplex</label>
                    ...
                    <div class="row">
                       ...
                       <div class="col-lg-5 col-md-12 col-sm-12 col-12">
                          <ul id="show-item">
                             ...
                             <li>
                                <a href="{{asset('grid-map-view.html')}}" class="btn btn-light ms-4">Map View</a>
                             </li>
                          </ul>
                       </div>
                    </div>
                          ...
                          <div class="row">
                             ...
                             <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="sub-main">
                                   ...
                                   <div class="slider-content">
                                      ...
                                      <h5><a href="{{asset('hotel-single-page.html')}}">Hotel in JPS</a></h5>
                                      <a href="{{asset('javascript:;')}}"> <span class="clr-text"><i class="fas fa-map-marker-alt"></i>
                                            Republic of Cuba,
                                            USA</span></a>
                                   </div>
                             ...
                             <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="sub-main">
                                   ...
                                   <div class="slider-content">
                                      ...
                                      <h5><a href="{{asset('hotel-single-page.html')}}">The Peninsula</a></h5>
                                      <a href="{{asset('javascript:;')}}"> <span class="clr-text"><i class="fas fa-map-marker-alt"></i>
                                            Republic of Cuba,
                                            USA</span></a>
                                   </div>
                             ...
                             <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="sub-main">
                                   <div class="img-sec p-rel">
                                      <div class="hover-img p-rel">
                                         <a href="{{asset('javascript:;')}}"> <img src="{{asset('images/blog-4.jpg')}}" alt=""></a>
                                      </div>
                                      <span>$30 / Night</span>
                                   </div>
                                   <div class="slider-content">
                             ...
                             <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="sub-main">
                                   ...
                                   <div class="slider-content">
                                      ...
                                      <h5><a href="{{asset('hotel-single-page.html')}}">Mandarin Oriental</a></h5>
                                      <a href="{{asset('javascript:;')}}"> <span class="clr-text"><i class="fas fa-map-marker-alt"></i>
                                            Republic of Cuba,
                                            USA</span></a>
                                   </div>
                                ...
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      ...
                                      <div class="slider-content">
                                         ...
                                         <h5><a href="{{asset('hotel-single-page.html')}}">hotel sayaji indore</a></h5>
                                         <a href="{{asset('javascript:;')}}"> <span class="clr-text"><i
                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      <div class="img-sec p-rel">
                                         <div class="hover-img p-rel">
                                            <a href="{{asset('hotel-single-page.html')}}"> <img src="{{asset('images/blog-2.jpg')}}" alt=""></a>
                                         </div>
                                         <span>$77 / Night</span>
                                      </div>
                                      <div class="slider-content">
                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      <div class="img-sec p-rel">
                                         <div class="hover-img p-rel">
                                            <a href="{{asset('')}}"> <img src="{{asset('images/blog-3.jpg')}}" alt=""></a>
                                         </div>
                                         <span>$77 / Night</span>
                                      </div>
                                      <div class="slider-content">
                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      <div class="img-sec p-rel">
                                         <div class="hover-img p-rel">
                                            <a href="{{asset('javascript:;')}}"> <img src="images/blog-1.jpg')}}" alt=""></a>
                                         </div>
                                         <span>$77 / Night</span>
                                      </div>
                                      <div class="slider-content">
                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      <div class="img-sec p-rel">
                                         <div class="hover-img p-rel">
                                            <a href="{{asset('javascript:;')}}"> <img src="images/blog-2.jpg')}}" alt=""></a>
                                         </div>
                                         <span>$77 / Night</span>
                                      </div>
                                      <div class="slider-content">
                             ...
                             <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="list-type">
                                   <div class="list-sub-main list-width-type">
                                      <div class="img-sec p-rel">
                                         <div class="hover-img p-rel">
                                            <a href="{{asset('javascript:;')}}"> <img src="images/blog-3.jpg')}}" alt=""></a>
                                         </div>
                                         <span>$77 / Night</span>
                                      </div>
                                      <div class="slider-content">
    ...
    <!-- pagination start -->
        <nav>
           <ul class="pagination pagination-lg justify-content-center">
               <li class="page-item">
                   <a class="page-link" href="{{asset('#')}}" tabindex="-1" aria-disabled="true"><i class="fas fa-arrow-left"></i></a>
               </li>
               <li class="page-item res-d-none"><a class="page-link" href="{{asset('#')}}">1</a></li>
               <li class="page-item active res-d-none" aria-current="page">
                   <a class="page-link" href="{{asset('#')}}">2</a>
               </li>
               <li class="page-item res-d-none"><a class="page-link" href="{{asset('#')}}">3</a></li>
               <li class="page-item res-d-none"><a class="page-link" href="{{asset('#')}}">...</a></li>
               <li class="page-item res-d-none"><a class="page-link" href="{{asset('#')}}">5</a></li>
               <li class="page-item  active ">
                   <a class="page-link" href="{{asset('#')}}"><i class="fas fa-arrow-right"></i></a>
               </li>
           </ul>
       </nav>
    <!-- pagination end -->
...
<!-- sign up for newletter start -->
    <div class="contact-main-wrapper">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                <div class="form">
                    <h5><a href="{{asset('javascript:;')}}">sign up for newsletter</a></h5>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-12 p-0">
                <div class="offer-tag">
                    <h5><a href="{{asset('javascript:;')}}">Summer Holidays 20% OFF</a></h5>
...
<!-- sign up for newletter end -->

{{-- methode 1 search method --}}
// $result = cat_spec_art
            //     ::join('dep_ville_art', 'cat_spec_art.user_id', '=', 'dep_ville_art.user_id')
            //     ->join('user', function ($join) {
            //         $join->on('user.id', '=', 'cat_spec_art.user_id')
            //             ->on('user.id', '=', 'dep_ville_art.user_id');
            //     })
            //     ->join('departement', 'departement.id', '=', 'dep_ville_art.departement_id')
            //     ->where('categorie_id', '=', isset($categorie) ? $categorie : null)
            //     ->where('departement_id', '=', isset($departement) ? $departement : null);
            // if (isset($specialite) || isset($ville)) {
            //     $result1 = $result->where('specialite_id', '=', $specialite)
            ...
            // ];
{{-- methode 2 search method --}}

// $result = cat_spec_art
//     ::join('dep_ville_art', 'cat_spec_art.user_id', '=', 'dep_ville_art.user_id')
//     ->join('user', 'user.id', '=', 'cat_spec_art.user_id')
//     // ->leftJoin(DB::raw('(select count(*) as nombreCommentaire from commentaire group by user_id) as commentaire'), 'commentaire.user_id', '=', 'user.id')
//     ->leftJoin('commentaire', 'user.id', '=', 'commentaire.user_id')->select('count(*) as nbCom')
//     ->join('departement', 'departement.id', '=', 'dep_ville_art.departement_id')
//     ->join('categorie', 'categorie.id', '=', 'cat_spec_art.categorie_id')
//     ->when(isset($specialite) && isset($ville), function ($query) use ($specialite, $ville) {
//         return $query
//             ->join('ville', 'ville.id', '=', 'dep_ville_art.ville_id')
//             ->join('specialite', 'specialite.id', '=', 'cat_spec_art.specialite_id')
//             ->select('*');
//     }, function ($query) {
//         return $query->select('user.*', 'departement.*', 'categorie.*');
//     })
...
<div id="small-dialog" class="zoom-anim-dialog mfp-hide dialog-with-tabs">
	...
	<div class="sign-in-form">
		...
		<ul class="popup-tabs-nav">
			<li><a href="#tab" class="text-capitalize text-dart fw-bold">contacter </a></li>
		</ul>
		...
		<div class="popup-tabs-container">
			...
			<div class="popup-tab-content" id="tab">
				...
				<div class="welcome-text">
					<h3>Discuss your project <i class="text-primary">{{$profile->nom_societe}}</i></h3>
				</div>
					
                <!-- Display validation errors -->
				<!-- Form -->
				<form method="POST" action="{{route('Visiteur.mailing',$profile->id)}}">
                    @csrf
					...
					<div class="input-with-icon-left">
                        ...
                        <input type="text" 
                        class="input-text with-border @error('Nom') border border-danger @enderror text-capitalize" 
                        name="Nom" id="nom" 
                    ...
                    <div class="input-with-icon-left">
                        ...
                        <input type="text" 
                        class="input-text with-border @error('Telephone') border border-danger @enderror text-capitalize"
                    ...
                    <div class="input-with-icon-left">
                        ...
                        <input type="text" 
                        class="input-text with-border @error('Email') border border-danger @enderror"
                    ...
                    <div class="input-with-icon-left">
                        ...
                        aria-hidden="true"></i>
                        <input type="text" 
                        class="input-text with-border @error('Sujet') border border-danger @enderror" 
                        name="Sujet" id="Sujet" placeholder="Sujet"/>
                        @error('Sujet')
                        <div class="text-danger">{{$message}}</div>
                        @enderror
					</div>
					<textarea 
                    name="Message" cols="10" 
                    placeholder="Message" 
                    class="with-border @error('Message') border border-danger @enderror" ></textarea>
                    @error('Message')
                        <div class="text-danger">{{$message}}</div>
                    @enderror
...
MAIL_PORT=2525
MAIL_USERNAME=2d63966087ed3d
MAIL_PASSWORD=1ed7146953b0d6
MAIL_ENCRYPTION=tls
{{-- ----------------------------------------- --}}
// else {
   //     $data = [
   //         'recepient' => $artisanEmail->email,
   ...
   //     try {
   //         Mail::send('email-templet', $data, function ($message) use ($data) {
